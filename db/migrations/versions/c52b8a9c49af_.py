...
Revision ID: c52b8a9c49af
Revises: 
Create Date: 2023-08-25 01:58:27.571320
...
def upgrade() -> None:
    ...
    sa.Column('collection_fk', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['collection_fk'], ['collection.dir_id'], ),
